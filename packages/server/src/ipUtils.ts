...
import { logger, EXTERNAL_DNS } from '@stuntman/shared';
...
export class IPUtils {
    ...
    externalDns: dns.Resolver;

    constructor(options: { mockUuid: string; externalDns?: [string, ...string[]] }) {
        this.mockUuid = options.mockUuid;
        this.externalDns = new DNSResolver();
        this.externalDns.setServers(options?.externalDns || EXTERNAL_DNS);
